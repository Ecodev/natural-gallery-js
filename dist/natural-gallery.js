...
(function (Natural) {
    ...
    (function (Gallery) {
        var Core = (function () {
             ...
             */
            Core.prototype.initGallery = function () {
             ...
             * @param rows
             */
            Core.prototype.addElements = function (gallery, rows) {
                ...
                for (var i = nextImage; i < collection.length; i++) {
                    ...
                    if (element.row < lastRow) {
                        ...
                        var figure = this.getFigure(element, gallery);
            ...
            Core.prototype.cleanCategories = function (gallery) {
                var categoriesCount = {};
                for (var i = 0; i < gallery.images.length; i++) {
                    var image = gallery.images[i];
                    var categories = this.getImageCategories(image);
            ...
            Core.prototype.getImageCategories = function (image) {
             ...
             * @returns {*}
             */
            Core.prototype.getDefaultPageSize = function (gallery) {
                if (gallery.limit) {
             ...
             */
            Core.prototype.getFigure = function (element, gallery) {
             ...
             * @param gallery
             */
            Core.prototype.styleFigure = function (element, gallery) {
                element.figure.figure
             ...
             * @param gallery
             */
            Core.prototype.bindClick = function (image, gallery) {
                var self = this;
             ...
             * @param gallery
             */
            Core.prototype.filterSelection = function (gallery) {
                var filtered = [];
                var filteredByTerm = this.filterByTerm(gallery);
                var filteredByCategory = this.filterByCategory(gallery);
            ...
            Core.prototype.filterByTerm = function (gallery) {
                var term = this.utility.removeDiacritics(gallery.rootElement.find('.natural-gallery-searchTerm input').val()).toLowerCase();
                var filteredImages = [];
                // show all if empty
                if (term.length === 0) {
                    ...
                    for (var i = 0; i < gallery.images.length; i++) {
                        var image = gallery.images[i];
                        var needle = this.utility.removeDiacritics(image.title + " " + (image.description ? image.description : '')).toLowerCase();
            ...
            Core.prototype.filterByCategory = function (gallery) {
                var selectedCategories = this.getSelectedCategories(gallery);
            ...
            Core.prototype.getSelectedCategories = function (gallery) {
             ...
             * @param gallery
             */
            Core.prototype.reset = function (gallery) {
                gallery.pswpContainer = [];
             ...
             * @returns {*}
             */
            Core.prototype.getGallery = function (element) {
             ...
             */
            Core.prototype.redraw = function (gallery) {
                var galleries = gallery ? [gallery] : naturalGalleries;
                for (var i = 0; i < galleries.length; i++) {
                    var gallery_1 = galleries[i];
                    var nbRows = gallery_1.images[gallery_1.pswpContainer.length - 1].row + 1;
                    this.reset(gallery_1);
                    this.addElements(gallery_1, nbRows);
                }
            };
            Core.prototype.bindEvents = function () {
                ...
                $('.natural-gallery-searchTerm input[type="text"]').on('keydown', function (event) {
                    ...
                    var gallery = self.getGallery(this);
                ...
                if (naturalGalleries.length == 1 && this.getGallery().limit === 0) {
                    $(document).on('scroll', function () {
                        var gallery = self.getGallery().bodyElement;
...
(function (Natural) {
    ...
    (function (Gallery) {
        var Organizer = (function () {
            ...
            Organizer.prototype.organize = function (gallery) {
                var galleries = gallery.constructor === Array ? gallery : [gallery];
                for (var i = 0; i < galleries.length; i++) {
                    var gallery_2 = galleries[i];
                    var elements = gallery_2.filtered ? gallery_2.selection : gallery_2.images;
                    if (gallery_2.thumbnailFormat == 'natural') {
                        this.organizeNatural(elements, gallery_2.bodyElementWidth, gallery_2.thumbnailMaximumHeight, gallery_2.margin);
                    }
                    else if (gallery_2.thumbnailFormat == 'square') {
                        this.organizeSquare(elements, gallery_2.bodyElementWidth, gallery_2.imagesPerRow, gallery_2.margin);
                    }
                }
            };
            /**
             ...
             * @param margin
             */
            Organizer.prototype.organizeSquare = function (elements, containerWidth, nbPictPerRow, margin) {
                if (!margin) {
                    margin = 0;
                }
                if (!nbPictPerRow) {
             ...
             * @param row
             */
            Organizer.prototype.organizeNatural = function (elements, containerWidth, maxRowHeight, margin, row) {
            ...
            Organizer.prototype.computeSizes = function (chunk, containerWidth, margin, row, maxRowHeight) {
            ...
            Organizer.prototype.getRowWidth = function (maxRowHeight, margin, elements) {
                return margin * (elements.length - 1) + this.getRatios(elements) * maxRowHeight;
            };
            Organizer.prototype.getRowHeight = function (containerWidth, margin, elements) {
                return containerWidth / this.getRatios(elements) + margin * (elements.length - 1);
            };
            Organizer.prototype.getRatios = function (elements) {
                var self = this;
                var totalWidth = 0;
                for (var i = 0; i < elements.length; i++) {
            ...
            Organizer.prototype.getImageRatio = function (el) {
                return Number(el.tWidth) / Number(el.tHeight);
            };
            Organizer.prototype.apportionExcess = function (elements, containerWidth, rowWidth) {
...
(function (Natural) {
    ...
    (function (Gallery) {
        var Utility = (function () {
            ...
            Utility.prototype.construct = function () { };
            Utility.prototype.removeDiacritics = function (str) {
                for (var i = 0; i < this.defaultDiacriticsRemovalMap.length; i++) {
                    str = str.replace(this.defaultDiacriticsRemovalMap[i].letters, this.defaultDiacriticsRemovalMap[i].base);
                }
                return str;
            };
            return Utility;
...
},{}],"/sites/_libraries/natural-gallery.lan/node_modules/photoswipe/dist/photoswipe-ui-default.js":[function(require,module,exports){
...
},{}]},{},["/sites/_libraries/natural-gallery.lan/app/build.js"])
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
