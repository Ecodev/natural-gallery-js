...
(function (Organizer) {
     ...
     * @param margin
     */
    function organizeSquareByRowHeight(elements, containerWidth, maxRowHeight, margin) {
        if (!margin) {
            margin = 0;
        }
     ...
     * @param margin
     */
    function organizeSquareByImagesPerRow(elements, containerWidth, nbPictPerRow, margin) {
        if (!margin) {
            margin = 0;
        }
        if (!nbPictPerRow) {
