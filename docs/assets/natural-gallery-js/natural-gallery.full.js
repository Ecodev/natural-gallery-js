...
var AbstractGallery = /** @class */ (function () {
    ...
    AbstractGallery.prototype.init = function () {
        ...
        this.flushBufferedItems = _.debounce(function () {
            _this.scrollBufferedItems.forEach(function (i) {
                i.loadImage();
                _this.dispatchEvent('item-displayed', i.model);
            });
    ...
    Object.defineProperty(AbstractGallery.prototype, "selectedItems", {
        get: function () {
            return this.visibleCollection.filter(function (item) { return item.selected; }).map(function (item) { return item.model; });
        },
        enumerable: true,
        configurable: true
    });
...
var Item = /** @class */ (function () {
    ...
    Object.defineProperty(Item.prototype, "enlargedWidth", {
        get: function () {
    ...
    Object.defineProperty(Item.prototype, "enlargedHeight", {
        get: function () {
