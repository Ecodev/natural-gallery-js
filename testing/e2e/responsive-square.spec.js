...
describe('Natural', () => {
    ...
    it('should create gallery, init, scroll and resize"', async () => {
        ...
        await page.evaluate(() => new NaturalGallery.ResponsiveSquare(document.getElementById('root'), {rowHeight: 400}).addItems(images));
        ...
        await page.setViewport({width: 1460, height: page.viewport().height});
